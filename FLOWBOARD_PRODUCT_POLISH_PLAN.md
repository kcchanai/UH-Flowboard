...
**Status: implementation in progress on `luna/product-polish`; Step 7 is complete and Step 8 is in progress.**
...
The approved Step 7 envelope is shell 26,000, index.html 27,000, and lazy 58,000 gzip/source limits as measured in `artifacts/product-polish/step-07/results.md`. Future measured prototypes may propose another transition, but no limit is raised merely to avoid consolidation; document and vendor transfer remain measured separately.
