...
try {
  for (const view of [{name:'desktop-1440x900',width:1440,height:900},{name:'resized-960x720',width:960,height:720}]) {
    ...
    await page.screenshot({path:`artifacts/polish/step-05/${view.name}.png`,fullPage:true});
    await context.close();
  }
} finally { await browser.close(); }
console.log('desktop_screenshots=2');
