...
export const DIST_GZIP_LIMITS = Object.freeze({'initial shell':26_000, 'first-party lazy':58_000});
...
export const SOURCE_LIMITS = Object.freeze({
  'index.html': 27_000, 'styles.css': 40_000, 'state-core.js': 20_000, 'app.js': 80_000,
