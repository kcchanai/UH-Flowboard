...
export const PRODUCTION_SOURCE_FILES = Object.freeze([
  ...
  'src/main.js', 'src/runtime-bootstrap.js', 'src/config.js', 'src/canvas-palettes.js', 'src/ui-preferences.js', 'src/board-view-model.js', 'src/density-ui.js', 'src/list-view-ui.js', 'src/appearance-ui.js', 'src/person-badges.js', 'src/cloud-roster-ui.js', 'src/cloud-sync-controller.js', 'src/activity-ui.js', 'src/assignment-ui.js', 'src/comments-ui.js',
