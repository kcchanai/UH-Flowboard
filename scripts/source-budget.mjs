...
export const PRODUCTION_SOURCE_FILES = Object.freeze([
  ...
  'src/auth-ui.js', 'src/auth-ui-style.js', 'src/cloud-workspace-ui.js', 'src/members-style.js', 'src/workspace-lifecycle-ui.js', 'src/invite-ui.js', 'src/members-ui.js', 'src/adapters/adapter-contract.js', 'src/adapters/local-workspace-adapter.js',
...
export const SOURCE_LIMITS = Object.freeze({
  ...
  'src/auth-ui.js': 8_000, 'src/auth-ui-style.js': 4_000, 'src/cloud-workspace-ui.js': 13_000, 'src/members-style.js': 4_000, 'src/workspace-lifecycle-ui.js': 4_500, 'src/invite-ui.js': 8_000, 'src/members-ui.js': 12_000, 'src/adapters/adapter-contract.js': 8_000,
