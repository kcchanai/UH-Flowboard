...
const adapter={listBoardDirectory:async()=>[space],fetchWorkspace:async()=>{calls+=1;await wait(calls===1?120:10);return{id:'scope-a',boards:[{id:'board-a',lists:[]},{id:'board-b',lists:[]}]};}};
